...
public class GridDrawer {
    ...
    public String drawGrid(Grid g) {
        ...
        sb.append(Drawing.repeat(he, w, cw, dTee, tlCorner, trCorner));
        sb.append(LF);
        for (int i = 0; i < h; i++) {
            sb.append(ve);
            for (int j = 0; j < w; j++) {
            ...
            sb.append(LF);
            if (i < h - 1) {
                sb.append(Drawing.repeat(hi, w, cw, cross, rTee, lTee));
            } else {
                sb.append(Drawing.repeat(he, w, cw, uTee, blCorner, brCorner));
            }
            sb.append(LF);
        }
        return sb.toString();
