...
public class Paths {
     ...
     *         specified class, or {@code null} if this code is not run from a Jar
     *         file (when run from eclipse for instance).
    ...
    public static String relativize(String baseDir, String absolutePath) {
        final java.nio.file.Path abs = java.nio.file.Paths.get(absolutePath);
        final java.nio.file.Path base = java.nio.file.Paths.get(baseDir);
        return base.relativize(abs).toString();
    }

    public static String relativizeSibling(String baseFile, String absolutePath) {
        final java.nio.file.Path abs = java.nio.file.Paths.get(absolutePath);
        final java.nio.file.Path base = java.nio.file.Paths.get(baseFile).getParent();
        return base.relativize(abs).toString();
    }
    ...
    public static String resolveSibling(String baseFile, String relativePath) {
        final java.nio.file.Path base = java.nio.file.Paths.get(baseFile);
